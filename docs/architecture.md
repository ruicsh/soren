...
- Provider abstraction for OpenAI-compatible and Anthropic APIs (supports OpenAI, Groq, Google Gemini, OpenCode Go, Hugging Face)
...
- Current types:
  - OpenAI-compatible streaming protocol (OpenAI, Groq, Google Gemini, OpenCode Go, Hugging Face)
